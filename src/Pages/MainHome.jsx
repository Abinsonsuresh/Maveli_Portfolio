    ...
    <>
      ...
      <AnimatePresence >
        <div className='flex relative justify-between flex-col md:flex-row items-center h-[90vh]  border-b-2 border-black w-screen'>
          ...
          <motion.div initial={{ opacity: 0, x: 100 }} whileInView={{ x: 0, opacity: 1 }} transition={{  duration: 0.5 }} className='flex absolute bottom-0 right-0 items-end justify-end  z-0'>
